...
<html lang="en">
	...
	<body>
		...
		<!--Page Wrapper Start-->
		<div id="wrapper" class=" homepage-2 error-wrapper">
			...
			<div id="content">
				...
				<section class="slider-hero error-page">
					<div class="container">
				...
				<section class="artical-part">
					<div class="container">
						<div class="error-content">
							<span class="num-cls-blck">4<strong class="num-cls-grn">0</strong>4</span>
							<span class="oops">ooopss!....sorry...page not found</span>
							<span class="lkg">the page you were looking for could not be found.</span>
							<a class="button-btn btn-error" href="index.html">Go to homepage</a>
						</div>
